...
return (
    ...
    <div className="navbar bg-base-100 mb-8 mt-4">
        ...
        <input type="checkbox" onChange={handleToggle} className="toggle theme-controller bg-orange-500 border-sky-400 [--tglbg:theme(colors.sky.500)] checked:bg-blue-300 checked:border-blue-800 checked:[--tglbg:theme(colors.blue.900)] row-start-1 col-start-1 col-span-2 mr-2"/>
